...
add_filter( 'graphql_connection_page_info', 'AtlasSearch\Support\WpGraphql\graphql_connection_page_info', 10, 2 );
...
add_filter( 'graphql_connection_edges', 'AtlasSearch\Support\WpGraphql\graphql_connection_edges' );
...
add_action(
	...
	static function ( $hits, $query_vars ) {
...
add_filter(
	...
	static function ( $value, $query_vars ) {
