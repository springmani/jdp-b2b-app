...
class Batch_Sync_Factory {
	/**
	 * @var \Wpe_Content_Engine\Helper\Sync\Batches\Batch_Sync_Interface[] DATA_TO_SYNC
	 */
	public const DATA_TO_SYNC = [
	 ...
	 *
	 * @return \Wpe_Content_Engine\Helper\Sync\Batches\Batch_Sync_Interface
	 */
	public static function build(
		string $batch_sync_class_name,
		$is_network_activated = false,
		$current_site_id = null
	): Batch_Sync_Interface {
