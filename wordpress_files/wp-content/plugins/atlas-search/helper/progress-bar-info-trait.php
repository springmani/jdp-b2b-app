...
trait Progress_Bar_Info_Trait {
	/**
	 * @var \Wpe_Content_Engine\Core_Wp_Wrapper\Wp_Progress_Bar $progress_bar Progress Bar.
	 */
	protected $progress_bar = null;

	/**
	 * @param \Wpe_Content_Engine\Core_Wp_Wrapper\Wp_Progress_Bar|null $progress_bar Progress Bar.
	 */
