...
class Updater {
	...
	public function plugin_row_meta( $links, $file ) {
		if ( $file == $this->name ) {
			$row_meta = array(
				'changelog' => '<a href="' . admin_url( 'plugin-install.php?tab=plugin-information&plugin=wpae-acf-add-on&section=changelog&TB_iframe=true&width=600&height=800' ) . '" class="thickbox open-plugin-details-modal" title="' . esc_attr( __( 'View WP All Export - ACF Add-On Pro Changelog', 'wp_all_export_acf_add_on' ) ) . '">' . __( 'Changelog', 'wp_all_export_acf_add_on' ) . '</a>',
			);
